...
public class Main4a3 {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 12; i++){
			Agent[] agents0 = {new Agent(0, i, i, 1, 500, 1, "user"), a0_1, a0_2};
			...
			Agent[] agents1 = {new Agent(0, i, i, 1, 500, 1, "user"), a1_1, a1_2};
			before = System.currentTimeMillis();
			...
			Agent[] agents2 = {new Agent(0, i, i, 1, 500, 1, "user"), a2_1, a2_2};
			before = System.currentTimeMillis();
			...
			Agent[] agents3 = {new Agent(0, i, i, 1, 500, 1, "user"), a3_1, a3_2};
			before = System.currentTimeMillis();
			...
			Agent[] agents4 = {new Agent(0, i, i, 1, 500, 1, "user"), a4_1, a4_2};
			before = System.currentTimeMillis();
